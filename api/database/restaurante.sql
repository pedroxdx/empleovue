...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2019 at 02:00 AM
...
INSERT INTO `area` (`id`, `sector`, `nombre`) VALUES
(1, 1, 'Chef'),
(2, 1, 'Cocinero'),
(3, 1, 'Ayudante de cocina'),
(4, 2, 'Barman'),
(5, 3, 'Maitre'),
(6, 3, 'Mesero'),
(7, 3, 'Sommelier'),
...
(10, 4, 'Lavatraste'),
(11, 4, 'Intendente'),
(12, 5, 'Responsable de compras'),
(13, 5, 'Secretaria'),
(14, 5, 'Capturista'),
(15, 5, 'Contador'),
(16, 6, 'Gerente de sucursal'),
(17, 6, 'Gerente regional'),
(18, 6, 'Gerente general'),
(19, 7, 'Pasantia no remunerada'),
(20, 1, 'Chef de cocina'),
(21, 1, 'Chef ejecutivo'),
(22, 1, 'Sous chef'),
(23, 1, 'Jefe de Partida');
...
CREATE TABLE `ciudad` (
  `id` int(11) UNSIGNED NOT NULL,
  `estado_id` int(11) UNSIGNED NOT NULL COMMENT 'Relación con estados',
...
INSERT INTO `ciudad` (`id`, `estado_id`, `clave`, `nombre`, `activo`) VALUES
...
INSERT INTO `disponibilidad` (`id`, `nombre`) VALUES
(1, 'Tiempo Completo'),
(2, 'Medio Tiempo'),
(3, 'Temporal');
...
CREATE TABLE `empresa` (
  `id` int(11) UNSIGNED NOT NULL,
  `paquete` int(11) UNSIGNED DEFAULT NULL,
  `nombre` varchar(50) DEFAULT NULL,
  `razon_social` varchar(50) DEFAULT NULL,
  `rfc` varchar(50) DEFAULT NULL,
  `descripcion` text DEFAULT NULL,
  `giro` varchar(150) DEFAULT '',
  `email` varchar(150) DEFAULT NULL,
  `telefono` varchar(150) DEFAULT NULL,
  `direccion` text DEFAULT NULL,
  `cp` varchar(10) DEFAULT NULL,
  `estado` int(11) UNSIGNED NOT NULL,
  `ciudad` int(11) UNSIGNED NOT NULL,
...
INSERT INTO `empresa` (`id`, `paquete`, `nombre`, `razon_social`, `rfc`, `descripcion`, `giro`, `email`, `telefono`, `direccion`, `cp`, `estado`, `ciudad`, `sitio_web`, `logotipo`, `portada`, `activo`, `log`) VALUES
(1, 1, 'McDonalds', 'McDonalds SA de CV', 'MD5656RWERT', 'Bryas es un empresa comprometida con la calidad en la preparación de alimentos ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim adLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad', 'Comida Rápida', 'info@mcdonalds.com', '9999456327', 'Calle 45 #34A x 56 y 59.', '97120', 12, 2378, 'http://www.mcdonalds.com', 'mcdonald.jpg', 'img_1489531561_b352df76521e7349ca8e98c5ba31ce48.jpg', 1, '2017-01-30 23:03:48'),
(3, 1, 'Los Pollos', 'Los Pollos Hermanos SA de CV', 'LPLL6778WRTY', 'Bryas es un empresa comprometida con la calidad en la preparación de alimentos ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim adLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad', 'Comida Rápida', 'info@lospollos.com', '9994567432', 'Calle 22 #34-A Diag 5 Col. Campestre', '97100', 31, 2378, 'http://www.lospolloshermanos.com', 'pollo_loco.png', NULL, 1, '2017-02-16 18:12:31'),
(4, 2, 'Mi Viejo Molino', 'MI Viejo Molino SA de CV', 'MVJM345534MCDS', 'Espacio amplio con terraza grande y área infantil para tomar café con platillos mexicanos o internacionales.', 'Restaurante', 'contacto@miviejomolino.com', '289-3378', 'Cto. Colonias 132, Buenavista', '97127', 31, 2378, 'http://www.miviejomolino.com/', 'caesars.png', 'img_1502820273_de57788b9dbea6ef31729b5309b04a3e.jpg', 1, '2017-08-15 17:57:01'),
(5, 3, 'NECTAR', 'ORBI TRADE S DE RL DE CV', 'OTR120730HS2', 'Somos el restaurante Yucateco de mayor inovacion, siempre buscando las mejores recetas e innovando en la cocina tradicional maya, ', 'Restaurante', 'global@cielohammocks.com', '9240440', 'Av A García Lavín, Plaza Jardín Mérida', '97000', 31, 2378, 'http://www.nectarmerida.com.mx', 'sushi.jpg', 'img_1503093189_6e05ee17786e6b0a9c0cae87819862c2.jpg', 1, '2017-08-18 21:42:56'),
(6, 1, 'MiSushi', NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, 31, 2378, NULL, NULL, NULL, 1, '2017-09-20 15:20:12');
...
CREATE TABLE `estado` (
  ...
  `activo` tinyint(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabla de Estados de la República Mexicana' ROW_FORMAT=COMPACT;

--
-- Dumping data for table `estado`
--

INSERT INTO `estado` (`id`, `clave`, `nombre`, `abrev`, `activo`) VALUES
...
CREATE TABLE `oferta_empleo` (
  ...
  `sucursal` int(11) UNSIGNED DEFAULT NULL,
  ...
  `contratados` int(11) DEFAULT 0,
  `salario` decimal(10,2) DEFAULT NULL,
  `salario_moneda` int(11) UNSIGNED DEFAULT NULL,
  `salario_temporal` int(11) UNSIGNED DEFAULT NULL,
  `jornada_laboral` text DEFAULT NULL,
  `disponibilidad` int(11) UNSIGNED NOT NULL,
  `publicar` tinyint(4) NOT NULL DEFAULT 1,
  `log` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `oferta_empleo` (`id`, `empresa`, `sucursal`, `area`, `sector`, `puesto`, `descripcion`, `vigencia`, `vacantes`, `contratados`, `salario`, `salario_moneda`, `salario_temporal`, `jornada_laboral`, `disponibilidad`, `publicar`, `log`) VALUES
(1, 1, NULL, 1, 1, 'Chef pizzero con conocimiento en pastas', 'Liderar la elaboracion de platillos gourmet estilo Europeo para turno matutino. Manejo de materias primas e inventarios y supervision de calidad. El candidato seleccionado tambien apoyara en la elaboracion de productos de panaderia.', '2020-03-31', 2, 1, '12000.00', 1, 3, 'Lunes a Viernes, 8 AM - 6 PM y Sábados 8 AM - 1 PM.', 1, 1, '2017-01-30 23:05:25'),
(4, 1, 4, 3, 1, 'Cocinero', 'Manejo de materias primas e inventarios y supervision de calidad. El candidato seleccionado tambien apoyara en la elaboración de productos de panadería.', '2017-04-05', 2, 1, '13500.00', 1, 3, 'lunes a viernes 7 a 8', 1, 1, '2017-02-04 05:42:17'),
(5, 3, NULL, 1, 1, 'Chef especialista en carnes', 'Chef especialista en carnes que sea capaz de elegir las carnes más productivas.', '2017-04-18', 1, 0, '4500.00', 1, 3, 'Lunes a Viernes de 8:00 am a 7:00 pm', 1, 1, '2017-02-17 01:35:40'),
(6, 1, 3, 10, 4, 'Lavatrastes', 'Se solicita Lavatrastes', '2020-01-12', 1, 0, '5000.00', 1, 3, 'Lunes a Sábado de 9 am a 5 pm', 2, 1, '2017-03-16 01:46:28'),
(7, 1, NULL, 1, 1, 'Chef Ejecutivo', '', '2020-12-01', 1, 0, '25000.00', 1, 3, '9 a 5', 1, 1, '2017-06-03 05:44:25'),
(9, 4, NULL, 2, 1, 'Cocinero', 'Cocinero especializado en la preparación de pescado y productos marítimos.', '2020-09-30', 1, 0, '12500.00', 1, 3, 'De 9 am a 8 pm de Lunes a Viernes\r\nSábados Medio tiempo', 1, 1, '2017-08-15 18:12:18'),
(10, 1, NULL, 6, 3, 'Mesero', '', '2020-09-30', 1, 1, '4000.00', 1, 3, '', 1, 1, '2017-08-17 21:32:42'),
(11, 5, NULL, 21, 1, 'Chef', 'Solicitamos un chef ejecutivo con experiencia internacional, con experiencia manejando grupos, creativo, y habilidades administrativas', '2017-09-30', 2, 0, '50000.00', 1, 3, 'Horario abierto', 1, 1, '2017-08-18 22:41:20'),
(12, 5, NULL, 6, 3, 'Mesero', 'amable, buena presentacion', '2017-09-30', 5, 0, '4000.00', 1, 3, 'de 5pm a 1am', 1, 1, '2017-08-18 22:45:29'),
(13, 5, NULL, 6, 3, 'Capitán de Meseros', 'Capitán de meseros con experiencia en servicio de alimentos y bebidas, montaje, comandas, manejo de caja.', '2017-09-30', 1, 0, '7500.00', 1, 3, '8 horas', 1, 1, '2017-08-18 22:53:45'),
(14, 5, NULL, 8, 3, 'Hostess ', '', '2017-09-30', 3, 0, '5000.00', 1, 3, '8 horas', 1, 1, '2017-08-18 22:55:51'),
(15, 4, 5, 6, 3, 'Ayudante de Mesero', 'Educación mínima: Educación secundaria\r\nEdad: entre 18 y 35 años\r\nDisponibilidad de viajar: No\r\nDisponibilidad de cambio de residencia: No ', '2017-09-30', 3, 0, '6500.00', 1, 3, 'Lunes a Viernes de 7:00 pm a 1:00 am', 1, 1, '2017-08-21 18:00:05'),
(16, 4, NULL, 4, 2, 'Barman', 'Se solicita a una persona responsable con al menos 6 meses de experiencia en el area, el cual domine el idioma inglés con gran naturalidad', '2017-09-30', 1, 0, '5500.00', 1, 3, 'De martes a domingo de 1pm a 11:30pm', 1, 1, '2017-08-21 18:15:27'),
(17, 4, 6, 16, 6, 'Gerente de Sucursal', 'El Gerente de Sucursal será responsable de toda la gestión comercial y operativa de la Sucursal, a través de la administración de todas las áreas en sus distintos ámbitos de acción, como recursos humanos, de infraestructura, tecnológicos y financieros, con la finalidad de cumplir metas, objetivos e indicadores propuestos por dirección, creando rentabilidad y crecimiento a la empresa.', '2017-09-30', 1, 0, '10000.00', 1, 3, 'De Lunes a Sábado de 9 am. a 7 pm.', 1, 1, '2017-08-21 18:26:06');
...
INSERT INTO `paquetes` (`id`, `nombre`, `ofertas`, `vigencia`, `estatus`, `log`) VALUES
(1, 'Básico', 5, 30, 1, '2017-07-31 20:04:52'),
(2, 'Avanzado', 10, 30, 1, '2017-07-31 20:05:10'),
(3, 'Premium', 1000, 30, 1, '2017-07-31 20:05:27');
...
INSERT INTO `sucursal` (`id`, `empresa`, `nombre`, `direccion`, `cp`, `telefono`, `estado`, `ciudad`, `activo`, `log`) VALUES
(3, 1, 'Ciudad Caucel', 'Calle 34 #4B x 56 y 57A Colonia García Ginerez', '97134', '987654', 23, 1839, 1, '2017-03-14 18:13:00'),
(4, 1, 'Centro', 'Calle 44 x 45 y 47 Centro', '97001', '9876545', 31, 2378, 1, '2017-03-14 18:14:21'),
(5, 4, 'Plaza Dorada', 'Plaza Dorada Calle 50 Num. 143 Locales 111, 112 y 113, Nueva Hidalgo', '97220', '01 999 987 1308', 31, 2378, 1, '2017-08-15 18:07:20'),
(6, 4, 'Alta Brisa', 'Avenida 7 532 x calle 24 y 22, Maya', '97169', '01 999 289 3381', 31, 2378, 1, '2017-08-15 18:08:28'),
(7, 5, 'Nectar', 'Calle 65 Num 510a\r\nx 62 y 64 centro', '97000', '+529999240440', 31, 2378, 1, '2017-08-18 22:36:46');

-- --------------------------------------------------------

--
-- Table structure for table `unidad_temporal`
--

CREATE TABLE `unidad_temporal` (
  `id` int(11) UNSIGNED NOT NULL,
  `nombre` varchar(50) DEFAULT NULL,
  `plural` enum('s','es') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `unidad_temporal`
--

INSERT INTO `unidad_temporal` (`id`, `nombre`, `plural`) VALUES
(1, 'Día', 's'),
(2, 'Semana', 's'),
(3, 'Mes', 'es'),
(4, 'Año', 's');
...
(1, 'Pedro Cicero', 'pedroxdx@gmail.com', NULL, '$2y$10$7UlzWUbkCbMLIRZrDcQHwe9LR0RuTXd.cnLgj9hscJJgoa/tW188C', NULL, '2019-08-29 02:01:02', '2019-08-29 02:01:02');
...
ALTER TABLE `area`
  ADD PRIMARY KEY (`id`),
  ADD KEY `categoria_ibfk_1` (`sector`);
...
ALTER TABLE `ciudad`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ciudad_ibfk_1` (`estado_id`);
...
ALTER TABLE `empresa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `empresa_ibfk_1` (`estado`),
  ADD KEY `empresa_ibfk_2` (`ciudad`),
  ADD KEY `empresa_ibfk_3` (`paquete`);
...
--
-- Indexes for table `oferta_empleo`
--
ALTER TABLE `oferta_empleo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `oferta_empleo_ibfk_1` (`area`),
  ADD KEY `oferta_empleo_ibfk_2` (`sector`),
  ADD KEY `oferta_empleo_ibfk_3` (`disponibilidad`),
  ADD KEY `oferta_empleo_ibfk_6` (`empresa`),
  ADD KEY `oferta_empleo_ibfk_7` (`salario_moneda`),
  ADD KEY `oferta_empleo_ibfk_8` (`salario_temporal`),
  ADD KEY `oferta_empleo_ibfk_9` (`sucursal`);
...
ALTER TABLE `sucursal`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sucursal_ibfk_1` (`empresa`),
  ADD KEY `sucursal_ibfk_2` (`estado`),
  ADD KEY `sucursal_ibfk_3` (`ciudad`);

--
-- Indexes for table `unidad_temporal`
--
ALTER TABLE `unidad_temporal`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `oferta_empleo`
--
ALTER TABLE `oferta_empleo`
...
--
-- AUTO_INCREMENT for table `unidad_temporal`
--
ALTER TABLE `unidad_temporal`
...
--
ALTER TABLE `area`
  ADD CONSTRAINT `area_ibfk_1` FOREIGN KEY (`sector`) REFERENCES `sector` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ciudad`
--
ALTER TABLE `ciudad`
  ADD CONSTRAINT `ciudad_ibfk_1` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`id`);

--
-- Constraints for table `empresa`
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `empresa_ibfk_1` FOREIGN KEY (`estado`) REFERENCES `estado` (`id`),
  ADD CONSTRAINT `empresa_ibfk_2` FOREIGN KEY (`ciudad`) REFERENCES `ciudad` (`id`),
  ADD CONSTRAINT `empresa_ibfk_3` FOREIGN KEY (`paquete`) REFERENCES `paquetes` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `oferta_empleo`
--
ALTER TABLE `oferta_empleo`
  ADD CONSTRAINT `oferta_empleo_ibfk_1` FOREIGN KEY (`area`) REFERENCES `area` (`id`),
  ADD CONSTRAINT `oferta_empleo_ibfk_2` FOREIGN KEY (`sector`) REFERENCES `sector` (`id`),
  ADD CONSTRAINT `oferta_empleo_ibfk_3` FOREIGN KEY (`disponibilidad`) REFERENCES `disponibilidad` (`id`),
  ADD CONSTRAINT `oferta_empleo_ibfk_4` FOREIGN KEY (`empresa`) REFERENCES `empresa` (`id`),
  ADD CONSTRAINT `oferta_empleo_ibfk_5` FOREIGN KEY (`salario_moneda`) REFERENCES `moneda` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `oferta_empleo_ibfk_6` FOREIGN KEY (`salario_temporal`) REFERENCES `unidad_temporal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `oferta_empleo_ibfk_7` FOREIGN KEY (`sucursal`) REFERENCES `sucursal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sucursal`
--
ALTER TABLE `sucursal`
  ADD CONSTRAINT `sucursal_ibfk_1` FOREIGN KEY (`empresa`) REFERENCES `empresa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sucursal_ibfk_2` FOREIGN KEY (`estado`) REFERENCES `estado` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `sucursal_ibfk_3` FOREIGN KEY (`ciudad`) REFERENCES `ciudad` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
